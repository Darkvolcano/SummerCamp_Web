...
const DriverSidebar: React.FC<DriverSidebarProps> = ({ onCollapsedChange }) => {
  ...
  return (
    <div className={`driver-sidebar ${isCollapsed ? "collapsed" : ""}`}>
      {/* Toggle Button */}
      ...
      <div className="sidebar-header">
        <div className="logo-container">
          ...
          {!isCollapsed && <span className="logo-text">Driver</span>}
        </div>
      </div>
          ...
          {!isCollapsed && (
            <>
              <div className="user-details">
                ...
                <div className="user-role">Camp Driver</div>
              </div>
