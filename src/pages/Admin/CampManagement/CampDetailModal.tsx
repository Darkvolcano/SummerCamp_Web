...
import { X, Edit2, Trash2, Calendar, MapPin, Users, DollarSign, Tag } from "lucide-react";
        ...
        <div className="modal-overlay">
            <div className="modal-content camp-detail-modal">
                ...
                <div className="detail-scroll">
                    ...
                    {/* Additional Info */}
                    {(camp.campTypeId || camp.locationId) && (
                        <div className="detail-section">
                            <h3 className="section-title">
                                <Tag size={20} />
                            ...
                            <div className="additional-info">
                                {camp.campTypeId && (
                                    <div className="info-item">
                                        ...
                                        <span className="info-val">{camp.campTypeId}</span>
                                    </div>
                                )}
                                {camp.locationId && (
                                    <div className="info-item">
                                        <span className="info-key">Location ID:</span>
                                        <span className="info-val">{camp.locationId}</span>
                                    </div>
                                )}
                                <div className="info-item">
