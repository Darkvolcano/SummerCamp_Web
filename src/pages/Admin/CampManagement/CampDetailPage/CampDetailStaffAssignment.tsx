            ...
            <div className="px-6 py-3 border-b border-[#E5E7EB] flex items-center justify-between gap-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex-1 px-3 py-1 bg-[#059669] text-white text-sm font-medium rounded-lg hover:bg-[#047857]"
                      >
                        Yes
                      </button>
                      <button
              ...
              >
                <button
                  ...
                  className="flex-shrink-0 inline-flex items-center gap-1 px-3 py-1 bg-[#059669] text-white rounded-lg hover:bg-[#047857] transition-all font-medium text-xs disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
                >
                  Assign{" "}
