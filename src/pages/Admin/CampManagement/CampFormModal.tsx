...
import { X, Save, Calendar, MapPin, Users, DollarSign, Image as ImageIcon } from "lucide-react";
import campService, { type CampRequestDto, type CampResponseDto } from "../../../services/campService";
...
export default function CampFormModal({
    ...
    const [errors, setErrors] = useState<Partial<Record<keyof CampRequestDto, string>>>({});
                        ...
                        <div className="form-row">
                            <div className="form-group">
                                ...
                                {errors.minParticipants && (
                                    <span className="error-message">{errors.minParticipants}</span>
                                )}
                            </div>
