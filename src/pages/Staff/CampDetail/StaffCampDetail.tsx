      ...
      <div className="p-6 flex items-center justify-center min-h-[500px]">
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-indigo-200 p-12 rounded-2xl text-center shadow-lg max-w-md">
          ...
          <p className="text-indigo-700 text-base leading-relaxed">
            Vui lòng chọn một trại từ thanh bên để xem chi tiết
          </p>
        </div>
      </div>
    );
    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-[#6B7280] text-sm mt-1">
          Xem thông tin trại được phân công
        </p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-[#E5E7EB] overflow-hidden mb-6">
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-[#374151]">Trại viên</p>
                  <p className="text-sm text-[#6B7280]">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-[#374151]">Giá</p>
                  <p className="text-sm text-[#6B7280]">
              ...
              {camp.campType && (
                <div className="flex items-start gap-3">
                  <Info size={20} className="text-[#6366F1] mt-1" />
                  <div>
                    <p className="text-sm font-semibold text-[#374151]">Loại Trại</p>
          ...
          <div className="mt-6 pt-6 border-t border-[#E5E7EB]">
            ...
            >
              <Users size={20} />
              Xem Tất Cả Trại Viên Trong Trại
            </button>
          </div>
        </div>
      </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-[#E5E7EB] overflow-hidden">
            <div className="px-6 py-4 bg-gradient-to-r from-green-50 to-emerald-50 border-b border-[#E5E7EB]">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-bold text-[#111827]">Nhóm Giám Sát</h3>
              </div>
            </div>
            <div className="p-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-[#E5E7EB] overflow-hidden">
            <div className="px-6 py-4 bg-gradient-to-r from-orange-50 to-amber-50 border-b border-[#E5E7EB]">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-bold text-[#111827]">Giám sát chỗ ở</h3>
              </div>
            </div>
            <div className="p-6">
              <div className="space-y-3">
          ...
          <div className="col-span-2 bg-blue-50 border-2 border-blue-200 rounded-lg p-8">
            <div className="text-center">
              ...
              <p className="text-blue-700">
                Bạn chưa được phân công nhóm giám sát hoặc chỗ ở nào cho trại này.
              </p>
            </div>
          </div>
        )}
      ...
      <Modal
        title={
          <div className="flex items-center gap-2">
            ...
            <span>Tất cả trại viên có trong trại {camp.name}</span>
          </div>
        }
      ...
      <Modal
        title={
          <div className="flex items-center gap-2">
            <Users size={20} className="text-green-600" />
            <span>Trại viên trong nhóm {group?.groupName}</span>
          </div>
        }
        ...
        <Spin spinning={loadingCampers}>
          <div className="max-h-[500px] overflow-y-auto">
            {groupCampers.length === 0 ? (
              <div className="text-center py-8 text-gray-500">
                Không tìm thấy trại viên nào trong nhóm này
              </div>
            ) : (
              <div className="divide-y divide-gray-200">
                {groupCampers.map((camper) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <p className="font-semibold text-gray-900">{camper.camperName}</p>
                      <p className="text-sm text-gray-500">
                        {camper.gender} • Sinh ngày: {formatDate(camper.dob)}
                      </p>
                    </div>
                    {camper.camperRegistrationStatus && (
      ...
      <Modal
        title={
          <div className="flex items-center gap-2">
            <Home size={20} className="text-orange-600" />
            <span>Trại viên trong chỗ ở {accommodation?.name}</span>
          </div>
        }
        ...
        <Spin spinning={loadingCampers}>
          <div className="max-h-[500px] overflow-y-auto">
            {accommodationCampers.length === 0 ? (
              <div className="text-center py-8 text-gray-500">
                Không tìm thấy trại viên nào trong chỗ ở này
              </div>
            ) : (
              <div className="divide-y divide-gray-200">
